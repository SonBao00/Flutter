  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: PandaBar(
        buttonData: [
          PandaBarButtonData(id: 'Home', icon: Icons.home_filled, title: 'Home'),
          PandaBarButtonData(
              id: 'Search', icon: Icons.email_rounded, title: 'Message'),
          PandaBarButtonData(
              id: 'Setting', icon: Icons.build_rounded, title: 'Setting'),
          PandaBarButtonData(
              id: 'Profile', icon: Icons.assignment_ind_rounded, title: 'Profile'),
        ],
        onChange: (id) {
          setState(
            () {
