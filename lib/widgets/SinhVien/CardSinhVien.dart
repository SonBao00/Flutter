...
import 'package:quanlysvthuctap/views/ChiTietSinhVien/ChiTietSinhVien.dart';
                                      ...
                                      style: ButtonStyle(
                                        backgroundColor:
                                            MaterialStateProperty.all(Colors
                                                .lightBlueAccent), // button color
                                      ),
                                      onPressed: () {
                                        SinhVien tempTreEm =
                                            new SinhVien.cloneByObject(
                                                widget.student);
                                        widget.setState(() {
                                          widget.listView
